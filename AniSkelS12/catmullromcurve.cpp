...
void CatMullRomCurve::evaluateCurve(
	...
	if(bWrap) {
		...
		Point wrapped_pt1(ptvCtrlPts[numCtrPt-1].x-fAniLength,
	...
	//Last
	Point tmp1(2*ctrl_pts[numCtrPt-1].x-ctrl_pts[numCtrPt-2].x,
		2*ctrl_pts[numCtrPt-1].y - ctrl_pts[numCtrPt-2].y);
